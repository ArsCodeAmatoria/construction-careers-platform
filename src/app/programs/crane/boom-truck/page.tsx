...
const details = {
  ...
  certification: "BC Crane Safety Certification",
  ...
  prerequisites: [
    ...
    "Valid Class 3 driver's license (or willing to obtain)"
  ],
    ...
    <div className="flex flex-col items-center space-y-16 py-8">
      ...
      <section className="text-center space-y-6 max-w-4xl px-4">
        ...
        <p className="text-xl text-muted-foreground max-w-[700px] mx-auto">
          Master the operation of folding boom trucks with unlimited tonnage certification. 
          Learn essential skills for safe and efficient crane operations.
        </p>
      </section>
      ...
      <section className="text-center space-y-6">
        ...
        <p className="text-muted-foreground max-w-[600px] mx-auto">
          Join our boom truck operator program and build a rewarding career in crane operations.
        </p>
