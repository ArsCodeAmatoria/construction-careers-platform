...
const courseContent = [
  ...
  {
    title: "Operation Skills",
    items: [
      "Machine controls mastery",
...
const details = {
  ...
  certification: "Heavy Equipment Operator Certificate",
  prerequisites: [
    ...
    <div className="space-y-16 py-8">
      <section className="text-center space-y-4">
        ...
        <p className="text-xl text-muted-foreground max-w-[800px] mx-auto">
          Master the skills needed to operate excavators safely and efficiently
        </p>
      ...
      <section className="w-full max-w-4xl mx-auto px-4 text-center space-y-6">
        ...
        <p className="text-lg text-muted-foreground">
          Begin your journey to becoming a certified excavator operator
        </p>
